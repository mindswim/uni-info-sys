...
class CreditLimitExceededException extends BusinessRuleViolationException
{
    ...
    public function getCurrentCredits(): int { return $this->currentCredits; }
    public function getAttemptedCredits(): int { return $this->attemptedCredits; }
    public function getMaxCredits(): int { return $this->maxCredits; }
}
